...
export const workflowStepToneByType: Record<WorkflowNodeType, string> = {
  ...
  delegate: "border-violet-700 bg-violet-50 text-violet-950",
  ...
  break: "border-lime-700 bg-lime-50 text-lime-950",
  ...
  knowledge_register_dataset: "border-amber-900 bg-amber-50 text-amber-950",
  knowledge_context_index: "border-amber-600 bg-amber-50 text-amber-950",
  file_list: "border-sky-700 bg-sky-50 text-sky-950",
  file_read: "border-sky-700 bg-sky-50 text-sky-950",
  file_write: "border-rose-700 bg-rose-50 text-rose-950"
};
