...
export interface WorkflowKnowledgeSearchConfig {
  datasetKey?: string;
  datasetKeyFrom?: string;
  queryFrom?: string;
  topKFrom?: string;
  keywordQueryFrom?: string;
...
export interface WorkflowKnowledgeIngestTextConfig {
  datasetKey?: string;
  datasetKeyFrom?: string;
  textFrom?: string;
  metadataFrom?: string;
  scopeFrom?: string;
  maxCharsFrom?: string;
  overlapCharsFrom?: string;
  ingestionIdFrom?: string;
  batchSizeFrom?: string;
  processorStrategyFrom?: string;
  extractPrimitivesFrom?: string;
}

export interface WorkflowKnowledgePromoteConfig {
