...
const LOOKUP: BagShape = nullable(object({ kind: STRING, query: nullable(STRING), id: nullable(STRING), datasetKey: STRING }, ["kind", "query", "id"]));
const ROUTE: BagShape = object({
  route: STRING, reason: STRING, question: nullable(STRING), lookup: LOOKUP,
  lookupKind: nullable(STRING), lookupQuery: nullable(STRING), lookupId: nullable(STRING), lookupDatasetKey: STRING,
...
function knowledgeNode(): WorkflowNode {
  return {
    ...
    data: {
      ...
      // The configured Assistant dataset is authoritative. The route may
      // refine it, but a model omission of the redundant lookupDatasetKey
      // must not turn a valid knowledge lookup into an empty-dataset error.
      knowledgeSearch: {}
    }
  };
}
...
const DECISION_INSTRUCTIONS = [
  "Durable context pack: {{contextPack}}", "Pending delegation: {{pendingDelegation}}", "Configured knowledge dataset: {{knowledgeDataset}}", "Agents: {{agentFacts}}",
  "Selected agent: {{agentFact}}", "Entity matches: {{entityMatches}}", "Selected entity: {{entityFact}}", "Workspace file entries: {{fileEntries}}", "Workspace file path: {{filePath}}", "Workspace file content: {{fileContent}}", "Knowledge datasets: {{knowledgeCatalog}}", "Knowledge tools: {{knowledgeTools}}", "Knowledge usage: {{knowledgeUsageHint}}", "Knowledge hits: {{knowledgeHits}}",
...
const REPLY_INSTRUCTIONS = [
  ...
  "Retrieved agents: {{agentFacts}}", "Retrieved agent: {{agentFact}}", "Retrieved entity matches: {{entityMatches}}", "Workspace file entries: {{fileEntries}}", "Workspace file path: {{filePath}}", "Workspace file content: {{fileContent}}", "Knowledge datasets: {{knowledgeCatalog}}", "Knowledge tools: {{knowledgeTools}}", "Knowledge usage: {{knowledgeUsageHint}}", "Retrieved knowledge: {{knowledgeHits}}",
...
export const assistantTurnGraph: WorkflowGraph = {
  ...
  edges: [
    ...
    data("d_start_session", "start", "session", "session_read", "session"), data("d_start_window", "start", "windowSize", "session_read", "windowSize"), data("d_start_knowledge_dataset_decision", "start", "knowledgeDataset", "llm_decide", "knowledgeDataset"), data("d_start_knowledge_dataset_search", "start", "knowledgeDataset", "search_knowledge", "datasetKey"), data("d_start_knowledge_access", "start", "knowledgeAccess", "search_knowledge", "access"),
    ...
    data("d_context_decision", "llm_context", "contextPack", "llm_decide", "contextPack"), data("d_agents_decision", "list_agents", "entities", "llm_decide", "agentFacts"), data("d_agents_reply", "list_agents", "entities", "llm_reply", "agentFacts"), data("d_file_entries_decision", "list_files", "entries", "llm_decide", "fileEntries"), data("d_file_entries_reply", "list_files", "entries", "llm_reply", "fileEntries"), data("d_file_path", "read_file", "path", "llm_decide", "filePath"), data("d_file_content_decision", "read_file", "content", "llm_decide", "fileContent"), data("d_file_path_reply", "read_file", "path", "llm_reply", "filePath"), data("d_file_content_reply", "read_file", "content", "llm_reply", "fileContent"), data("d_knowledge_catalog_decision", "knowledge_context_index", "datasets", "llm_decide", "knowledgeCatalog"), data("d_knowledge_catalog_tools_decision", "knowledge_context_index", "tools", "llm_decide", "knowledgeTools"), data("d_knowledge_catalog_usage_decision", "knowledge_context_index", "usageHint", "llm_decide", "knowledgeUsageHint"), data("d_knowledge_catalog_reply", "knowledge_context_index", "datasets", "llm_reply", "knowledgeCatalog"), data("d_knowledge_catalog_tools_reply", "knowledge_context_index", "tools", "llm_reply", "knowledgeTools"), data("d_knowledge_catalog_usage_reply", "knowledge_context_index", "usageHint", "llm_reply", "knowledgeUsageHint"), data("d_knowledge_decision", "search_knowledge", "hits", "llm_decide", "knowledgeHits"), data("d_knowledge_reply", "search_knowledge", "hits", "llm_reply", "knowledgeHits"), data("d_decision_break", "llm_decide", "decision", "break_decision", "value"), data("d_context_reply", "llm_context", "contextPack", "llm_reply", "contextPack"), data("d_context_end", "llm_context", "contextPack", "end", "contextPack"),
    ...
    data("d_break_route", "break_decision", "route", "decision_switch", "route"), data("d_break_kind", "break_decision", "lookupKind", "lookup_switch", "lookupKind"), data("d_break_query_search", "break_decision", "lookupQuery", "search_entities", "q"), data("d_break_query_knowledge", "break_decision", "lookupQuery", "search_knowledge", "query"), data("d_break_dataset_knowledge", "break_decision", "lookupDatasetKey", "search_knowledge", "datasetKey"), data("d_break_query_files", "break_decision", "lookupQuery", "list_files", "path"), data("d_break_id_agent", "break_decision", "lookupId", "get_agent", "id"), data("d_break_id_entity", "break_decision", "lookupId", "get_entity", "id"), data("d_break_id_neighborhood", "break_decision", "lookupId", "neighborhood", "id"), data("d_break_id_file", "break_decision", "lookupId", "read_file", "path"), data("d_break_agent", "break_decision", "agentId", "delegate", "agentId"), data("d_break_task", "break_decision", "task", "delegate", "task"), data("d_break_run", "break_decision", "runId", "delegate", "runId"), data("d_break_message", "break_decision", "message", "delegate", "message"), data("d_start_pending_delegate", "start", "pendingDelegation", "delegate", "pendingDelegation"),
