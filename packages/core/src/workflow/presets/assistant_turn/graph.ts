...
export const assistantTurnGraph: WorkflowGraph = {
  ...
  edges: [
    ...
    data("d_start_session", "start", "session", "session_read", "session"), data("d_start_window", "start", "windowSize", "session_read", "windowSize"), data("d_start_knowledge_dataset_decision", "start", "knowledgeDataset", "llm_decide", "knowledgeDataset"), data("d_start_knowledge_access", "start", "knowledgeAccess", "search_knowledge", "access"),
