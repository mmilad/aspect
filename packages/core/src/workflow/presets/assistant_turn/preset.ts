...
export const assistantTurnPreset: WorkflowPreset = {
  ...
  body: [
    ...
    "The decision node uses the versioned Assistant role manifest and chooses reply, clarify, retrieve, delegate, or resume. Retrieval is bounded and uses only read-only Query, typed knowledge_context_index, knowledge_search, file_list, or file_read nodes.",
