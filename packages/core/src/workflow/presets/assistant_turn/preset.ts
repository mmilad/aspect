...
export const assistantTurnPreset: WorkflowPreset = {
  ...
  body: [
    ...
    "The decision node uses the versioned Assistant role manifest and chooses reply, clarify, retrieve, delegate, or resume. Retrieval is bounded and uses only read-only Query or knowledge_search nodes.",
